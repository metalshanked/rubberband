...
const settingDefs: Array<Omit<SettingField, 'locked' | 'hasValue' | 'value' | 'defaultValue' | 'source'>> = [
  ...
  { key: 'WEB_SEARCH_ENABLED', label: 'Web search enabled', type: 'checkbox', group: 'llm' },
  { key: 'WEB_SEARCH_BASE_URL', label: 'Web search API base URL', type: 'text', group: 'llm' },
  { key: 'WEB_SEARCH_API_KEY', label: 'Web search API key', type: 'password', group: 'llm' },
  { key: 'WEB_SEARCH_AUTH_SCHEME', label: 'Web search auth scheme', type: 'text', group: 'llm' },
  { key: 'WEB_SEARCH_MODEL', label: 'Web search LLM', type: 'text', group: 'llm' },
  { key: 'WEB_SEARCH_MAX_RESULTS', label: 'Web search max results', type: 'text', group: 'llm' },
  { key: 'WEB_SEARCH_TIMEOUT_MS', label: 'Web search timeout ms', type: 'text', group: 'llm' },
  ...
  { key: 'ELASTIC_QUERY_TIMEOUT_MS', label: 'Elastic query timeout ms', type: 'text', group: 'elastic' },
  ...
  { key: 'AUTO_REPORT_TOKEN_BUDGET', label: 'Auto Report token budget', type: 'text', group: 'profiler' },
  { key: 'AUTO_REPORT_DEEP_ANALYSIS_ENABLED', label: 'Auto Report deep analysis', type: 'checkbox', group: 'profiler' },
  { key: 'AUTO_REPORT_DEEP_AGENT_ENABLED', label: 'Auto Report deep agent', type: 'checkbox', group: 'profiler' },
  { key: 'AUTO_REPORT_PROBE_ROUNDS', label: 'Auto Report probe rounds', type: 'text', group: 'profiler' },
  { key: 'AUTO_REPORT_MAX_PROBES', label: 'Auto Report max probes', type: 'text', group: 'profiler' },
  { key: 'AUTO_REPORT_MAX_PROBE_ROWS', label: 'Auto Report max probe rows', type: 'text', group: 'profiler' },
  { key: 'AUTO_REPORT_MAX_FOCUS_TABLES', label: 'Auto Report max focus tables', type: 'text', group: 'profiler' },
  { key: 'AUTO_REPORT_MAX_MCP_TOOL_CALLS', label: 'Auto Report max selected tool calls', type: 'text', group: 'profiler' },
  { key: 'AUTO_REPORT_DEEP_AGENT_RECURSION_LIMIT', label: 'Auto Report deep agent recursion limit', type: 'text', group: 'profiler' },
...
const defaults: Record<string, string> = {
  ...
  ELASTIC_QUERY_TIMEOUT_MS: '300000',
  CLUSTERS_JSON: '',
  CLUSTERS_FILE: '',
  ...
  AUTO_REPORT_DEEP_ANALYSIS_ENABLED: 'true',
  AUTO_REPORT_DEEP_AGENT_ENABLED: 'true',
  AUTO_REPORT_PROBE_ROUNDS: '2',
  AUTO_REPORT_MAX_PROBES: '24',
  AUTO_REPORT_MAX_PROBE_ROWS: '50',
  AUTO_REPORT_MAX_FOCUS_TABLES: '40',
  AUTO_REPORT_MAX_MCP_TOOL_CALLS: '8',
  AUTO_REPORT_DEEP_AGENT_RECURSION_LIMIT: '32',
